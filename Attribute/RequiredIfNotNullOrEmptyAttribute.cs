...
public class RequiredIfNotNullOrEmptyAttribute : ValidationAttribute
{
    ...
    public RequiredIfNotNullOrEmptyAttribute(string propertyName, string description = null, string errorMessage = null)
    {
    ...
    protected override ValidationResult IsValid(object value, ValidationContext validationContext)
    {
        ...
        if (value != null && localValue != null &&
            ...
            !string.IsNullOrWhiteSpace(localValue)) return new(GenerateErrorMessage(property.Name));
    ...
    public string GenerateDescription(string propertyName, string targetName = null) =>
        Description ??
        $"\n * `{propertyName}` is **required** when `{targetName ?? PropertyName}` is **not** `null` or `String.Empty`";
    ...
    public string GenerateErrorMessage(string propertyName) =>
        ErrorMessage ?? $"{propertyName} is required when {PropertyName} is NOT null or empty";
}
